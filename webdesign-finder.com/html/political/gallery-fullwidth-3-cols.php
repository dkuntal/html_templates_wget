				...
				<div class="container">
					<div class="row">
						<div class="col-sm-12 text-center">
							<h1>Gallery Fullwidth 3 columns</h1>
							<ol class="breadcrumb">
								<li>
									<a href="/">
										Homepage
								...
								<li class="active">Gallery Fullwidth 3 columns</li>
							</ol>
						</div>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="isotope_container isotope row masonry-layout" data-filters=".isotope_filters">
								...
								<div class="isotope-item col-lg-4 col-md-6 col-sm-6 elections">
								...
								<div class="isotope-item col-lg-4 col-md-6 col-sm-6 meetings">
									<div class="vertical-item gallery-title-item content-absolute">
										<div class="item-media">
								...
								<div class="isotope-item col-lg-4 col-md-6 col-sm-6 electorat">
									<div class="vertical-item gallery-title-item content-absolute">
										<div class="item-media">
								...
								<div class="isotope-item col-lg-4 col-md-6 col-sm-6 policy">
									<div class="vertical-item gallery-title-item content-absolute">
										<div class="item-media">
								...
								<div class="isotope-item col-lg-4 col-md-6 col-sm-6 program">
									<div class="vertical-item gallery-title-item content-absolute">
										<div class="item-media">
