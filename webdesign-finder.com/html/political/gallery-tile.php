...
<body>
	...
	<div id="canvas">
		<div id="box_wrapper">
			...
			<section class="ls section_padding_top_110 columns_padding_0">
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="isotope_container isotope row masonry-layout" data-filters=".isotope_filters">
								...
								<div class="isotope-item col-lg-2 col-md-4 col-sm-6 elections">
								...
								<div class="isotope-item col-lg-4 col-md-4 col-sm-6 meetings">
									<div class="vertical-item gallery-item content-absolute text-center ds">
										<div class="item-media">
								...
								<div class="isotope-item col-lg-2 col-md-4 col-sm-6 electorat">
									<div class="vertical-item gallery-item content-absolute text-center ds">
										<div class="item-media">
								...
								<div class="isotope-item col-lg-2 col-md-4 col-sm-6 policy">
									<div class="vertical-item gallery-item content-absolute text-center ds">
										<div class="item-media">
								...
								<div class="isotope-item col-lg-2 col-md-4 col-sm-6 program">
									<div class="vertical-item gallery-item content-absolute text-center ds">
										<div class="item-media">
								...
								<div class="isotope-item col-lg-2 col-md-4 col-sm-6 meetings">
									<div class="vertical-item gallery-item content-absolute text-center ds">
										<div class="item-media">
											<img src="images/gallery/20.jpg" alt="">
											<div class="media-links">
												<div class="links-wrap">
													<a class="p-view prettyPhoto " title="" data-gal="prettyPhoto[gal]" href="images/gallery/20.jpg"></a>
													<a class="p-link" title="" href="gallery-single.html"></a>
												</div>
											</div>
										</div>
								...
								<div class="isotope-item col-lg-4 col-md-4 col-sm-6 program">
									<div class="vertical-item gallery-item content-absolute text-center ds">
										<div class="item-media">
